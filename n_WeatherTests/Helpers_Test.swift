...
final class ImageByCodeHelper_Test: XCTestCase {
    
    func test_allStrormCodes_returnStorm(){
    ...
    func test_allRainCodes_returnRain(){
...
final class DateTimeHelper_Test: XCTestCase {
